			...
			<div class="row">
				...
				<table class="table table-striped table-bordered table-hover">
		              ...
		              <?php 
					   ...
					   $sql = 'SELECT StudentID,StudentFirstName,StudentMiddleInitial,StudentLastName,StudentEmail,StudentPhoneNumber,Gender FROM STUDENT WHERE Gender = "Female"';
	 				   foreach ($pdo->query($sql) as $row) {
						   		echo '<tr>';
							   	echo '<td>'. $row['StudentID'] . '</td>';
								echo '<td>'. $row['StudentFirstName'] . '</td>';
							   	echo '<td>'. $row['StudentMiddleInitial'] . '</td>';
